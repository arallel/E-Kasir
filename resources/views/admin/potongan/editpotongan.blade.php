                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            name="nama_potongan" value="{{ $data->nama_potongan }}" id="nama_potongan"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            name="tgl_awal_potongan" value="{{ $data->tgl_awal_potongan }}" id="tgl_awal_potongan"
                                            placeholder="Nama potongan" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="date" class="form-control"
                                            name="tgl_akhir_potongan" value="{{ $data->tgl_akhir_potongan }}" id="tgl_akhir_potongan"
                                            placeholder="Nama potongan" >
                                        </div>
                                    </div>
                                </div>

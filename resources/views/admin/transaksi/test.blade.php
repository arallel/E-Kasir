                ...
                <div class="invoice-head">
                    ...
                    <div class="invoice-desc">
                        ...
                        <ul class="list-plain">
                            ...
                            <li class="invoice-admin"><span>Kasir</span>:<span>{{ $data->user->nama_pengguna }}</span></li>
                        </ul>
                    </div>
                </div><!-- .invoice-head -->
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Rp.{{ number_format($d->databarang->harga_barang) }}</td>
                                    <td>{{ $d->qty }}</td>
                                    <td>Rp.{{ number_format($d->harga_item) }}</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>

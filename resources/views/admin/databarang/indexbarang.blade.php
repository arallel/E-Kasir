...
@section('content')
                                                                ...
                                                                <ul class="link-list-opt no-bdr">
                                                                    ...
                                                                    <li><a
                                                                            href="{{ route('databarang.show', $barang->id_barang) }}"><em
                                                                                ...
                                                                                Barang</span></a></li>
                                                                    <li>
                                                                        {{-- <a href="#" type="button" data-id="{{ $barang->id_barang }}"><em
                                                                                class="icon ni ni-trash btn-delete"></em><span>Hapus
                                                                                Barang</span></a> --}}
                                                                                <a type="button" class="btn-delete" data-id="{{ $barang->id_barang }}"><em
                                                                                    class="icon ni ni-trash btn-delete"></em><span>Hapus
                                                                                    Barang</span></a>
                                                                    </li>
                                                                    {{-- <button type="button" class="btn btn-danger">Modal Danger</button> --}}
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li>
    ...
    <script>
        $(document).on('click', '.btn-delete', function() {
            var id = $(this).data('id');
            // console.log(id);
            $('#form-edit').attr('action', '/databarang/delete/' + id);

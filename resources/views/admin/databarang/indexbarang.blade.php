                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <ul class="link-list-opt no-bdr">
                                                <li><a type="button" data-id="{{ $barang->id_barang }}"  class="btn-stokjumlah"><em class="icon ni ni-edit"></em><span>Tambah Stok</span></a></li>
                                                <li>
                                                    <li><a href="{{ route('databarang.edit', $barang->id_barang) }}">    <em class="icon ni ni-edit"></em><span>Edit Barang</span></a>
                                                    </li>
                                                    <li><a href="{{ route('databarang.show', $barang->id_barang) }}"><em class="icon ni ni-eye"></em><span>Tampilkan
                                                    Barang</span></a></li>
                                                    <li><a type="button" class="btn-jumlah"data-id="{{ $barang->id_barang }}" data-route="{{ route('print.label.barang', $barang->id_barang) }}"><em class="icon ni ni-label btn-jumlah"></em><span>Print Label Harga</span></a>
                                                    </li>
